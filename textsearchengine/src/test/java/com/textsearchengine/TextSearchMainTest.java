...
public class TextSearchMainTest {
    ...
    public static void main(String[] args) {
        String path = "src/test/resources/test-dir";

        File file = new File(path);
        String absolutePath = file.getAbsolutePath();
        String directoryLocation = absolutePath;
        final File indexableDirectory = new File(directoryLocation);
